...
export default function Edit({ page }) {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Редактирование: {page.title}</h2>}>
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg p-6">
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700">Алиас (ссылка)</label>
                                    <input
                                        type="text"
                                        value={data.slug}
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <a href={route('admin.pages.index')} className="text-gray-600 hover:text-gray-900 transition">Назад</a>
                            </div>
